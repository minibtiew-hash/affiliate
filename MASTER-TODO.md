...
9. Trim the confirmed-good beat 2 clip to its target ~2.3s with `ffmpeg_utils.trim_clip`, then run one full end-to-end test via `generate_video_from_product()` on the validation test product
